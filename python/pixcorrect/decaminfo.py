# $Id: decaminfo.py 47951 2019-01-03 20:58:17Z rgruendl $
# $Rev:: 47951                            $:  # Revision of last commit.
# $LastChangedBy:: rgruendl               $:  # Author of last commit.
# $LastChangedDate:: 2019-01-03 14:58:17 #$:  # Date of last commit.
...
#       Currently the only known narrowband filter is N964
        if filter.strip()[0:4] == "N964":
            band = 'N964'
        else:
            band = 'X'
        ...
        band = 'X'
    if band == "X":
        print(f"Warning: get_band given an unrecognized filter pattern. FILTER keyword given as: {filter.strip():s}")
    return band
